...
public class TestBrandServiceM extends TestBase {
//    @Resource
//    private ItemServiceM itemServiceM;
//    @Resource
//    private RegionService regionService;
    private BrandServiceM brandServiceM;

   @Override
    protected void init() {
//        itemServiceM = context.getBean("itemServiceM", ItemServiceM.class);
       brandServiceM = context.getBean("brandServiceM", BrandServiceM.class);
//        Assert.assertNotNull(itemServiceM);
        Assert.assertNotNull(brandServiceM);
    }
...
//
    ...
    public void testGetSensitiveWords()throws Exception{
        ServiceResult<List<Brand>> result = brandServiceM.getBrandList();
        print(result,true);
    }
//
//    @Test
